...
-- Safe to run again: tables are preserved, policies and triggers are recreated.
...
-- Compatibility with older ClosetIQ databases.
...
select true as ready, 'ClosetIQ Supabase setup completed successfully' as message;
