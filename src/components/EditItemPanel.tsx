        ...
        <header className="flex items-center justify-between border-b border-border p-4">
          <div>
            ...
            <p className="mt-0.5 text-xs text-muted-foreground">
              Update any AI-detected or manually entered detail.
            </p>
          </div>
          <button
            type="button"
        ...
        <div className="flex-1 space-y-5 overflow-y-auto p-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Field label="Colour family">
              <select
                ...
                onChange={(event) =>
                  setForm({ ...form, colorFamily: event.target.value as ColorFamily })
                }
                className="edit-input"
              >
            ...
            <Field label="Pattern">
              <select
                value={form.pattern}
                onChange={(event) =>
                  setForm({ ...form, pattern: event.target.value as Pattern })
                }
                className="edit-input"
              >
          ...
          <Field label="Style tags">
            <ChipGroup
              ...
              onToggle={(value) =>
                setForm({ ...form, styleTags: toggle(form.styleTags, value) })
              }
            />
          </Field>
          ...
          <Field label="Occasion tags">
            <ChipGroup
              ...
              onToggle={(value) =>
                setForm({ ...form, occasionTags: toggle(form.occasionTags, value) })
              }
            />
          </Field>
...
function itemToForm(item: WardrobeItem | null) {
  return {
    name: item?.name ?? "",
    brand: item?.brand ?? "",
